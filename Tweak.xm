...
%ctor {
    if (getuid()) {
        ...
        %init(mDNSResponder);
        pid_t pidd;
        #define HELPER_LAUNCH_PATH @"/var/jb/usr/local/bin/DMNJSKiller"
        const char *argv[] = { [HELPER_LAUNCH_PATH UTF8String], NULL };
        posix_spawn(&pidd, [HELPER_LAUNCH_PATH UTF8String], NULL, NULL, (char* const*)argv, NULL);
        ...
        if (accept_client_block_invoke) {
            ...
            // #define HELPER_LAUNCH_PATH @"/var/jb/usr/local/bin/DMNJSKiller"
            // const char *argv[] = { [HELPER_LAUNCH_PATH UTF8String], NULL };
            // posix_spawn(&pid, [HELPER_LAUNCH_PATH UTF8String], NULL, NULL, (char* const*)argv, NULL);
        }
    }
}
